...
auth_users = [ int(chat) for chat in os.environ.get("1085174050,5934830127").split(",") if chat != '']
sudo_users = auth_users
sudo_groups = [ int(chat) for chat in os.environ.get("-1001663303433").split(",")  if chat != '']
